...
import com.example.personeltracking2026kodau.databinding.ActivityPersonelBinding
...
//    }
    ...
    private fun updateMqttUI() {
        ...
        pagerAdapter.mqttPort = if (config.useWebSocket) {
            config.wsPort.toString()
        } else {
            config.tcpPort.toString()
        }
